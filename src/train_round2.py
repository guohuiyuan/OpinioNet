...
if __name__ == "__main__":
    ...
    scheduler = GradualWarmupScheduler(
        optimizer, total_epoch=2 * max(len(makeup_train_loader), len(corpus_loader))
    )
    best_val_f1 = 0
    ...
    for e in range(EP):
        ...
        train_loss, train_lm_loss, train_f1, train_pr, train_rc = train_epoch(
            model,
            makeup_train_loader,
            laptop_train_loader,
            corpus_loader,
        ...
        print(
            "loss %.5f, lm loss %.5f f1 %.5f, pr %.5f, rc %.5f"
            % (train_loss, train_lm_loss, train_f1, train_pr, train_rc)
        )
        ...
        print(
            "makeup_val: loss %.5f, f1 %.5f, pr %.5f, rc %.5f"
            % (val_loss, val_f1, val_pr, val_rc)
        )
        ...
        print(
            "laptop_val: loss %.5f, f1 %.5f, pr %.5f, rc %.5f"
            % (val_loss, val_f1, val_pr, val_rc)
        )
