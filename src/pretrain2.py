...
def train_epoch(
    model, makeup_loader, laptop_loader, corpus_loader, optimizer, scheduler=None
):
    model.train()
...
if __name__ == "__main__":
    ...
    (
        ...
        laptop_val_loader,
        corpus_loader,
    ) = get_pretrain2_loaders(tokenizer, batch_size=args.bs)
    ...
    for e in range(EP):
        ...
        (
            ...
            model, makeup_loader, laptop_loader, corpus_loader, optimizer, scheduler
        )
        print(
        ...
        val_loss, val_f1, val_pr, val_rc, best_th = eval_epoch(
            model, laptop_val_loader, type="laptop"
        )
        print(
